...
public class SeanceFenetre extends JFrame{
    ...
    /// CONSTRUCTEURS
    /**Affichage de la fenetre détail de la séance*/
    SeanceFenetre(Seance seance, int iduser, Tabedt wa){
        this.seanceux = seance;
        user = taupe.retrieveUserFromID(iduser);
        ...
        if(user.getDroit()==3)
        {
            add(new BoutonModif(seanceux, this, wa));
        }
